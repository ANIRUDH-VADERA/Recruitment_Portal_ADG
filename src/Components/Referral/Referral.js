    ...
    <div className="refer-main">
      <div className="refer">
        ...
        <div className="body">
          ...
          <div>
            <p className="body-title">Referall Code</p>
          ...
          <div className="body-end">
            ...
            <p className="body-sub">
              Share your Referral Code with your friends to get them extra time
              and vice versa
              <br /> <br />
              Top 5 people whose code gets used the most will get an exclusive
              chance to speedtrack their Recruitments Process
            </p>
          </div>
          {/* Button Component */}
        </div>
